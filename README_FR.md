...
| **🎨 Matrix 3x3 FX** | Transformation RGB complète via une matrice 3x3 avec offsets R/G/B. Inclut intensité, préservation de la luminosité et limitation de sortie. Les presets sont gérés par le système JSON unifié. |
| **🎨 DCTL Tone Mapper FX** | Tone mapper filmique créatif / technique inspiré des workflows DCTL de Resolve. Inclut les modes Filmic Soft, Filmic Strong, ACES Approx, Reinhard et Cineon-ish, avec réglages d’exposition, contraste, pivot, rolloff des hautes lumières, lift des ombres, niveau de noir, saturation et préservation de la luminosité. |
